...
cssclasses:
  - 
---
>La **Codifica delle Features Categoriche** è il processo di *rappresentare [[021 Features Engineering#Feature|variabili categoriche]]* (o qualitative) con un *formato numerico* in modo che possano essere utilizzate efficacemente in modelli di machine learning. 

### Hashing Trick
>Per risolvere vari problemi che potrebbero emergere dall'utilizzo basilare delle codifiche, su usa l'**Hashing Trick**.
>Questo è un metodo *veloce* ed *efficiente in termini di spazio* per vettorizzare le caratteristiche. Quindi trasformare caratteristiche arbitrarie in *indici di un vettore o [[058 Matrici|matrice]]*.
